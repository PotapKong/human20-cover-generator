...
The image model should not recreate the logo from memory. If no logo asset is attached or available, leave clean space for manual logo placement or use a plain text footer: `Человек 2.0 · Среда внедрения ИИ`.
